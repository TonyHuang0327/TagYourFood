                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="text-center text-white">
                            <!-- Page heading-->
                            <h1 class="mb-5">食品營養標示系統<br>TagYourFood</h1><br>
                            <h2 class="mb-5"><a class="btn btn-warning" href="eatDiaryYesterDay.php">昨天</a>&emsp;<?php echo $today?>的飲食紀錄 &emsp;<a class="btn btn-warning" href="eatDiaryTomorrow.php">明天</a></h2><br>
<br>
                            <center>
                            <?php
                            $sql = "SELECT F.Food_Id,F.Food_Name,F.Calories,F.Protein,F.Fat 
                                    FROM foods F,user_eatDiary D 
                                    WHERE D.usr_account='$sessionID' AND D.Food_Id=F.Food_Id AND D.Date='".$today."';";
                            ...
                            echo "<td><center>刪除</center></td>";
                            echo "</tr>";
                            while($row=mysqli_fetch_assoc($result)){
                                echo "<tr>";
                                echo "<td>".$row["Food_Id"]."</td><td>".$row["Food_Name"]."</td><td>".$row["Calories"]."</td><td>".$row["Protein"]."</td><td>".$row["Fat"]."</td><td><a href = 'delete_confirm.php?Food_Id=".$row["Food_Id"]."'>刪除</a></td>";
                                echo "</tr>";
                            }
                            echo "</table>";
                            ?>
