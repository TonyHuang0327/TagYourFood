                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9">
                        <div class="text-center text-white">
                            ...
                            <h2 class="mb-5"><?php echo $today?>的飲食紀錄 &emsp;<a class="btn btn-warning" href="eatDiary.php">明天</a></h2><br>
<br>
                            <center>
                            <?php
                            $sql = "SELECT F.Food_Id,F.Food_Name,F.Calories,F.Protein,F.Fat FROM foods F,user_eatDiary D WHERE D.usr_account='$sessionID' AND D.Food_Id=F.Food_Id AND Date='$today'";
