                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6">
                        <div class="text-center text-white">
                            ...
                            <center><h2 class="mb-5">進階身體資料上傳</h2>
                            ...
                            <br/>
                            <font size="5">體脂率: </font><input type='number' name="bodyFat" placeholder='%' style = "width: 150px; height: 30px">
                            <br/><br/><br>
                            <font size="5">腰臀比: </font><input type='number' name="WHR" placeholder='比率' style = "width: 150px; height: 30px">
                            <br/><br/><br>
                            <input type='submit' value = '上傳/修改' style = "width: 120px; height: 40px;border:3px green double;">
                            </form>
                            </div>
                            <?php
                            if(isset($_POST['bodyFat']) && isset($_POST['WHR']))
                            if($_POST['bodyFat']!=NULL && $_POST['WHR']!=NULL){
                                $usr_bodyFat=$_POST['bodyFat'];
                                $usr_WHR=$_POST['WHR'];
                                $_SESSION['bodyFat']=$usr_bodyFat;
                                $_SESSION['WHR']=$usr_WHR;
                                header("Location:advancedBMIupload.php");
                            }
                            ?>
                        </div>
                    </div>
